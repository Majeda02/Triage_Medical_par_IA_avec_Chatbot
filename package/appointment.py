...
class Appointments(Resource):
    ...
    def post(self):
        ...
        appointment['app_id'] = conn.execute('''INSERT INTO appointment(pat_id,doc_id,appointment_date)
            VALUES(%s,%s,%s)''', (pat_id, doc_id,appointment_date)).lastrowid
        conn.commit()
        return appointment
...
class Appointment(Resource):
    ...
    def get(self,id):
        ...
        appointment = conn.execute("SELECT * FROM appointment WHERE app_id=%s",(id,)).fetchall()
        return appointment
    ...
    def delete(self,id):
        ...
        conn.execute("DELETE FROM appointment WHERE app_id=%s",(id,))
        conn.commit()
    ...
    def put(self,id):
        ...
        pat_id = appointment['pat_id']
        doc_id = appointment['doc_id']
        conn.execute("UPDATE appointment SET pat_id=%s,doc_id=%s WHERE app_id=%s",
                     (pat_id, doc_id, id))
        conn.commit()
        return appointment