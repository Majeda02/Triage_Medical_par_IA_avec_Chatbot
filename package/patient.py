...
class Patients(Resource):
    ...
    def post(self):
        ...
        patientInput['pat_id']=conn.execute('''INSERT INTO patient(pat_first_name,pat_last_name,pat_insurance_no,pat_ph_no,pat_address)
            VALUES(%s,%s,%s,%s,%s)''', (pat_first_name, pat_last_name, pat_insurance_no,pat_ph_no,pat_address)).lastrowid
        conn.commit()
        return patientInput
...
class Patient(Resource):
    ...
    def get(self,id):
        ...
        patient = conn.execute("SELECT * FROM patient WHERE pat_id=%s",(id,)).fetchall()
        return patient
    ...
    def put(self,id):
        ...
        pat_ph_no = patientInput['pat_ph_no']
        pat_address = patientInput['pat_address']
        conn.execute("UPDATE patient SET pat_first_name=%s,pat_last_name=%s,pat_insurance_no=%s,pat_ph_no=%s,pat_address=%s WHERE pat_id=%s",
